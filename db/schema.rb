...
ActiveRecord::Schema.define(version: 20171228063313) do

  create_table "addition_products", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "additions", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "special_products", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "product_id"
    t.boolean "is_limited"
    t.date "limited_start_date"
    t.date "limited_end_date"
